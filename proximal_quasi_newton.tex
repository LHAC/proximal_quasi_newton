...
\end{align}
where $\psi = \frac{1}{\theta}$ and $\theta$ is the same as specified in Lemma~\ref{lem:bound_iter_inexact}. Then,
\begin{align}
    \label{eq:bound_F_F*}
	F(x^k) - F(x^*) 
...
\begin{proof}
	...
	\end{align}
	Finally, \eqref{eq:bound_F_F*} follows from considering all cases \eqref{equ:_thm_conv_rate_case1}, \eqref{equ:_thm_conv_rate_case2} and \eqref{equ:_thm_conv_rate_case3}.
