...
There exists a positive constant $\delta$ such that for all $i = 0, ..., k-1$: $\|x^i - x^*\| \leq \delta$. 
\assume 
\label{assub:bound_h}
There exists a positive constant $M$ such that for all $i = 0, ..., k-1$: $0 \prec H_i \prec MI$ 
\end{assumption}
...
\end{align}
where $x^*$ is an optimal solution of \eqref{prob:P}, $\|x - x^*\| \leq \delta $ for all $f(x) \leq f(x^0)$  and $M$ is the bound of the largest eigenvalues of $H_k$.
\end{theorem}
