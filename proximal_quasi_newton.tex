...
\[
F(x^{k+1})-F(x^k)=\Delta_{k+1}-\Delta F_k\geq  \frac{\rho\sigma_k}{2M_k^2 (D_{\Xcal_0}+\frac{2L_g}{\sigma_k})^2}\Delta F_k^2,
\]
which establishes \eqref{eq:mainbnd} with $c_k= \frac{\rho\sigma_k^3}{2M_k^2 (D\sigma^k+2L_g)^2}$. 

Dividing by $\Delta_{k+1}\Delta F_k\leq \Delta_{k}^2$ we have
\[
